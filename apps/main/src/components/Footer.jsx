  ...
  return (
    <footer className="border-t border-ink-200 px-6 py-10 dark:border-ink-800">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 sm:flex-row">
        ...
        <p className="font-mono text-[11px] uppercase tracking-widest text-ink-400 dark:text-ink-400">
          Built with React · Designed monochrome
        </p>
        <div className="flex items-center gap-4">
          <a href={profile.github} target="_blank" rel="noreferrer" className="text-ink-500 transition-colors hover:text-ink-950 dark:text-ink-300 dark:hover:text-ink-50" aria-label="GitHub">
          ...
          <a href={profile.linkedin} target="_blank" rel="noreferrer" className="text-ink-500 transition-colors hover:text-ink-950 dark:text-ink-300 dark:hover:text-ink-50" aria-label="LinkedIn">
